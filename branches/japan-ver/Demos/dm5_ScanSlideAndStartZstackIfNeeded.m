%%  Slide scanning with Image based task spawning - Z stack example
% Here we show how to to scan a slide and decide based on image content
% whether to take a Z-stack at that posision or not; 
%
% The main take home message here is how to define spawning behaviour  
% 
